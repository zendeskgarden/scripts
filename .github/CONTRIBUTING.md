...
[issue](https://github.com/zendeskgarden/tool-shed/issues) is the
...
- `yarn start` to run the `garden` executable.
...
- `yarn build` to compile source TS to distribution JS. The build runs as
