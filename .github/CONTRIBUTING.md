...
[issue](https://github.com/zendeskgarden/scripts/issues) is the
...
on your system. After you clone this repo, run `npm` to install dependencies
needed for development. After installation, the following commands are
available:

- `npm start` to run the `garden` executable.
...
- `npm run build` to compile source TS to distribution JS. The build runs as
